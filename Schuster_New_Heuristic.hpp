 ...
 *
 * This heuristic stops the search for new 6-cycles once a certain value is passed
 * This value can be a fixed constant or dynamically based on the initial graph
 *
 * Restrictions
