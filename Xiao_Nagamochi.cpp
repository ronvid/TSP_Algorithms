...
/**
 * This is a C++ implementation of Xiao and Nagamochi's algorithm for the Traveling Salesman Problem
 * This file uses some code elements of my port of David Eppsteins TSP implementation
 * TODO name changes
 *
 * NOTE changes
...
std::function<bool()> main_ch = []{
    ...
    // Reduction of vertices with only two neighbours or two forced and one unforced neighbour
